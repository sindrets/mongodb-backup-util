...
export class EventHandler {
	 ...
	 */
	public static on(event: string | GlobalEvent | (string | GlobalEvent)[], listener: (...args: any[]) => void, once=false): void {
	 ...
	 */
	public static trigger(event: string | GlobalEvent, once=false, ...args: any[]): void {
